...
export const metadata: Metadata = {
  title: "Datenschutzerklärung – TBM-Rechner",
  description:
    "Datenschutzerklärung zur Nutzung des TBM-Rechners (Tokenbudget-Modell).",
  robots: { index: true, follow: true },
};

export default function DatenschutzPage() {
  return (
    <LegalShell eyebrow="Rechtliche Hinweise" title="Datenschutz­erklärung">
      ...
      <h3>Vercel</h3>
      <p>
        Anbieter ist die Vercel Inc., 440 N Barranca Avenue #4133, Covina, CA
        91723, USA (nachfolgend „Vercel"). Wenn Sie unsere Website besuchen,
      ...
      <p>
        ...
        der EU-Kommission gestützt. Vercel ist nach dem „EU-US Data Privacy
      ...
      <p>
        ...
        bis Sie diese selbst löschen oder eine automatische Löschung durch
      ...
      <p>
        ...
        funktionieren würden. Andere Cookies können zur Auswertung des
      ...
      <p>
        ...
        zur Bereitstellung bestimmter, von Ihnen erwünschter Funktionen oder
        zur Optimierung der Website (z. B. Cookies zur Messung des Webpublikums)
      ...
      <p>
        Diese Website nutzt Vercel Web Analytics, einen Webanalyse-Dienst der
        Vercel Inc., 440 N Barranca Avenue #4133, Covina, CA 91723, USA. Vercel
        Web Analytics erfasst aggregierte Daten zur Nutzung dieser Website
        (z. B. besuchte Seiten, Referrer, Browser, ungefährer Standort auf
        Länderebene) ohne den Einsatz von Cookies oder
        Tracking-Identifikatoren. IP-Adressen werden vor der Speicherung
        anonymisiert, sodass eine Identifizierung einzelner Personen nicht
        möglich ist.
      </p>
      <p>
        ...
        seine Werbung zu optimieren. Weitere Informationen finden Sie in der
      ...
      <p>
        Zusätzlich nutzen wir Vercel Speed Insights, um Performance-Metriken
        (Core Web Vitals wie LCP, INP, CLS) anonym zu erfassen. Auch hier
        werden keine personenbezogenen Daten gespeichert. Die Erfassung dient
        ausschließlich der technischen Optimierung der Website. Rechtsgrundlage
      ...
      <p>
        ...
        Fonts sind über Next.js lokal gehostet. Eine Verbindung zu Servern von
        Google findet beim Laden der Schriftarten dabei nicht statt.
      </p>
      <p>
